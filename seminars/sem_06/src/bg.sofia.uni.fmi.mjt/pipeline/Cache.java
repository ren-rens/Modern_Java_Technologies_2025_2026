...
public class Cache {
    ...
    public void cacheValue(Object key, Object value) {
        if (key == null || value == null) {
            throw new IllegalArgumentException("Invalid arguments given to cacheValue!");
        }
    ...
    public Object getCachedValue(Object key) {
        if (key == null) {
            throw new IllegalArgumentException("Key in Cache is null!");
        }
    ...
    public boolean containsKey(Object key) {
        if (key == null) {
            throw new IllegalArgumentException("Key is null in Cache.containsKey()!");
        }
