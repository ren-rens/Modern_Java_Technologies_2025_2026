...
public class Stage<I, O> {
    ...
    public static <I, O> Stage<I, O> start(Step<I, O> initialStep) {
        if (initialStep == null) {
            throw new IllegalArgumentException("InitialStep invalid in Stage.start");
        }
    ...
    public O execute(I input) {
        if (input == null) {
            throw new IllegalArgumentException("Invalid input given to execute");
        }
